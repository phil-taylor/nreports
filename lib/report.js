...
/**
 * Used to set the reporting template runtime for this report.
 * @chainable
 * @method setRuntime
 * @param {String} runtime (markdown | handlebars | jade)
 */
Report.prototype.setRuntime = function(runtime) {
	this.runtime = runtime;
	return this;
};

/**
 * Used to set the progress update url for this report.
 * @chainable
 * @param {ReportDatasource} progressUpdateUrl
 */
Report.prototype.setProgressUpdateUrl = function(progressUpdateUrl) {
		this.progressUpdateUrl = progressUpdateUrl;
		return this;
};
